...
root_dir = '/projectnb/bioinfor/SEGRE/goldford/CoenzymeSpecificity/pytfa/tests'
...
cobra_model = load_json_model(model_path + '/iJO1366.json')
...
fbaFile = root_dir + '/fba.solution.output.pkl'
tfbaFile = root_dir + '/tfba.solution.output.pkl'
...
tfbaFile = root_dir + '/tfba.noRelax.solution.output.pkl'
...
if tfa_value < 0.1:
    ...
    tfbaFile = root_dir + '/tfba.Relax.solution.output.pkl'
    with open(tfbaFile,'wb') as file:
        pickle.dump(tfa_solution, file)
